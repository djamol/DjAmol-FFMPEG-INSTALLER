...
echo "removing old source"
   ...
   tar -zxvf  $_package
   cd flvtool2-1.0.6/
   /usr/loca/avpffmpeg/bin/ruby setup.rb config
   /usr/loca/avpffmpeg/bin/ruby setup.rb setup
   /usr/loca/avpffmpeg/bin/ruby setup.rb install
   ln -s /usr/loca/avpffmpeg/bin/flvtool2 /usr/local/bin/flvtool2
   ln -s /usr/loca/avpffmpeg/bin/flvtool2 /usr/bin/flvtool2
   echo -e $RED"
                        :rvri                     
                  :vJUJYri:::::i::                
            .sDgEJi                 r7i           
