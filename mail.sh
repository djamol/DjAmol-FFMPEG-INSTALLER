...
#postconf -e myhostname = andreagrandi.it
...
mydestination = mail.domain.com, domain.com, localhost.localdomain, localhost
...
info@domain.com youremail@gmail.com
sales@domain.com youremail@live.com
